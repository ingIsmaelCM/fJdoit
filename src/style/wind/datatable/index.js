export default {
  ...
  column: {
    ...
    sort: ({ context }) => ({
      class: [
        ...
        context.sorted ? "dark:text-primary-400" : "dark:text-gray-200",
      ],
    }),
    ...
    filterrowitem: ({ context }) => ({
      class: [
        ...
        // Color
        { "text-gray-700 dark:text-gray-200": !context?.highlighted },
        {
    ...
    filtermenubutton: ({ context }) => ({
      class: [
        ...
        "dark:text-gray-200/70 dark:hover:text-gray-200 dark:bg-gray-700",
    ...
    rowRadioButton: {
      ...
      box: ({ props }) => ({
        class: [
          ...
          // Colors
          {
            "text-gray-700 dark:text-gray-200": !props.modelValue,
            "bg-gray-50 dark:bg-gray-700": !props.modelValue,
  ...
  bodyrow: ({ context, props }) => ({
    class: [
      ...
      { "bg-gray-50 dark:bg-gray-700": props.frozenRow },
      {
        "odd:bg-gray-50 odd:text-gray-600 dark:odd:bg-gray-800 even:bg-gray-50 even:text-gray-600 dark:even:bg-gray-700/60":
  ...
  rowgroupheader: {
    class: [
      "sticky z-20",
      "bg-gray-50 text-gray-600 dark:text-gray-200/70",
      "dark:bg-gray-700",
    ],
  },
  rowgroupfooter: {
