export default {
  root: ({ props }) => ({
    class: [
      ...
      {
        "before:absolute before:w-full before:rounded-md before:h-2 before:top-[1.25rem] before:left-0 before:bottom-0 before:bg-gray-100 dark:before:bg-gray-700":
  ...
  label: {
    class: [
      ...
      // Font and Text
      "text-sm text-gray-600 dark:text-gray-200/60",
      "leading-none",
    ],
  },
};
